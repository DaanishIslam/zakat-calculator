...
@Component({
  ...
  templateUrl: "./stepper-4.component.html",
  styleUrl: "./stepper-4.component.css",
...
export class Stepper4Component implements OnInit {
  ...
  openLandPropertyPanel(): void {
    this.panelService.openLandPropertyPanel();
  }
  openBusinessPanel(): void {
    this.panelService.openBusinessPanel();
  }
}
